...
def test_detection():
    ...
    test_texts = [
        ...
        "Positive Technologies и Лаборатория Касперского представили новые продукты по кибербезопасности.",
        "На встрече присутствовали представители Роснефти и Лукойла, также обсуждались вопросы с ВТБ.",
        "Яндекс и VK объявили о партнерстве в сфере IT-технологий.",
        "Самокат расширил экспресс-доставку, а маркетплейс Ozon открыл новый склад.",
        "Самолет вылетел из Шереметьево с задержкой — компания здесь ни при чем.",
    ]
...
def create_test_news():
    ...
    test_news = [
        ...
        NewsItem(
            title="Positive Technologies и Лаборатория Касперского объявили о сотрудничестве",
            url="https://example.com/news3",
            source="test",
            published_at=now - timedelta(days=3),
            summary="Компании договорились о совместной разработке новых технологий кибербезопасности. Партнерство охватывает облачные сервисы и искусственный интеллект."
        ),
        NewsItem(
        ...
        NewsItem(
            ...
            summary="Компания Яндекс объявила о крупных инвестициях в развитие технологий искусственного интеллекта. Проект поддерживается партнерами из VK."
        ),
        NewsItem(
            title="Самолет вылетел из Шереметьево с задержкой",
            url="https://example.com/news6",
            source="test",
            published_at=now - timedelta(days=6),
            summary="Рейс задержали из-за погодных условий. Пассажиров разместили в зале ожидания."
        ),
    ]
    ...
    try:
        ...
        if not all_companies:
            ...
            test_companies = [
                ...
                Company(name="Яндекс", source="forbes", rank=5, year=2023),
                Company(name="VK", source="forbes", rank=6, year=2023),
            ]
